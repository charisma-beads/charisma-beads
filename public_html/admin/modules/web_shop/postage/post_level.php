...
if (!$authorized) {
	...
	print "<tr><td height=\"25\" class=\"Link\" onMouseOver=\"this.className='bodyLink'\" onMouseOut=\"this.className='Link'\"><a href=\"add_post_level.php\" class=\"Link\">Add New Post Level</a></td></tr>";
    ...
    if (isset($_GET['np'])) {
        ...
        $query = "SELECT post_level_id FROM post_level ";
    ...
    if ($num > 0) { // If it ran OK, display the records.
        ...
        <tr bgcolor="#EEEEEE"><td align="center"><b>Post Level</b></td><td><b> </b></td><td><b> </b></td></tr>';
        ...
        while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) { 
			...
			print "<td align=\"center\"><a href=\"edit_post_level.php?plid={$row['post_level_id']}\" /><img src=\"/admin/images/edit.png\" alt=\"Edit Post Level\"/></a></td>";
			print "<td align=\"center\"><a href=\"delete_post_level.php?plid={$row['post_level_id']}\" /><img src=\"/admin/images/delete.png\" alt=\"delete Post Level\"/></a></td>";
			print "</tr>";
        }
