...
echo '<p>Please enter a valid username and password! Click <a href="./index.php">here</a> to try again!<p>';
	...
	print "<tr><td height=\"25\" class=\"Link\" onMouseOver=\"this.className='bodyLink'\" onMouseOut=\"this.className='Link'\"><a href=\"add_tax_rate.php\" class=\"Link\">Add New Tax Rate</a></td></tr>";
	...
	if (isset($_GET['np'])) {
		...
		$query = "SELECT tax_rate_id FROM tax_rates ";
	...
	if ($num > 0) { // If it ran OK, display the records.
		...
		// Table header.
		echo '<table align="center" cellspacing="2" cellpadding="2"><tr bgcolor="#EEEEEE"><td align="center"><b>Tax Rate</b></td><td><b> </b></td><td><b> </b></td></tr>';
		...
		while ($row = mysql_fetch_array($result, MYSQL_ASSOC)) { 
			...
			print "<td align=\"center\"><a href=\"edit_tax_rate.php?trid={$row['tax_rate_id']}\" /><img src=\"/admin/images/edit.png\" alt=\"Edit Tax Code\"/></a></td>";
			print "<td align=\"center\"><a href=\"delete_tax_rate.php?trid={$row['tax_rate_id']}\" /><img src=\"/admin/images/delete.png\" alt=\"delete Tax Code\"/></a></td>";
			print "</tr>";
		}
