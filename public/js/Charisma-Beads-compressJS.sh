...
cat mootools-core.js >> charismabeads.js
cat mootools-more.js >> charismabeads.js
...
java -jar /home/shaun/Public/charisma-beads/yuicompressor-2.4.2.jar -o charismabeads-compressed.js charismabeads.js
