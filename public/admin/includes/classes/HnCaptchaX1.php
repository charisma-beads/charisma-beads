<?php
/**
  * PHP-Class hn_captcha_X1 Version 1.5.0, released 24-Dec-2007
  *
  ...
  *
  * $Id: hn_captcha.class.x1.php5,v 1.4 2007/12/23 23:23:45 horst Exp $
  *
  ...
  *
  *
  * changes in version 1.2:   (2007-December-24)
  *
  *   - created the PHP 5 Version
  *
  *____
  *
  **/
...
class HnCaptchaX1 extends HnCaptcha
{
    ...
    //
        ...
        /** @private **/
        private $counter_fn_default_basename = 'hn_captcha_counter.txt';
    ...
    //
        ...
        public function __construct($config, $debug=FALSE, $secure=TRUE)
        {
			...
			parent::__construct($config, $debug, $secure);
    ...
    //
        ...
        /**
          ...
          *
          **/
        private function txt_counter($filename,$add=FALSE,$fixvalue=FALSE)
        {
