...
class Paypal {
   ...
   function __construct() {
      ...
      $this->ipn_log_file = $_SERVER['DOCUMENT_ROOT'] . '/../data/ipn_results.log';
      $this->ipn_log = true; 
      $this->ipn_response = '';
   ...
   function submit_paypal_post() {
      ...
      $f = "<center><h2>Please wait, your order is being processed and you";
      $f .= " will be redirected to the paypal website.</h2></center>\n";
      $f .= "<form method=\"post\" id=\"paypal_form\" ";
      $f .= "action=\"".$this->paypal_url."\">\n";

      foreach ($this->fields as $name => $value) {
         $f .= "<input type=\"hidden\" name=\"$name\" value=\"$value\"/>\n";
      }
      $f .= "<center><br/><br/>If you are not automatically redirected to ";
      $f .= "paypal within 10 seconds...<br/><br/>\n";
	  $f .= "<input type=\"submit\" class=\"submit\" value=\"Click Here\"></center>\n";
