...
function menu () {
	...
	print "<tr>";
	print "<td height=\"25\" class=\"menuLink\" onMouseOver=\"this.className='navbar'\" onMouseOut=\"this.className='menuLink'\"><p><a href=\"$https/logs\" class=\"menuLink\" target=\"_blank\">:: Web Statistics</a></p>";
	print "</td>";
	print "</tr>";
	print "<tr>";
    print "<td><img src=\"/admin/images/images/navspacer.gif\" width=\"140\" height=\"1\"></td>";
