...
function I_ApplyShadow(i) {
    ...
    if (I_SelectedText() == "") {
        ...
        if (i == 0) I_FormatText("text-shadow", "0px 2px 3px #666");
        if (i == 1) I_FormatText("text-shadow", "4px 4px 0px rgba(255,255,255,.8), 10px 10px 0px rgba(187,187,187,0.5)");
        if (i == 2) I_FormatText("text-shadow", "0 1px 0 #ccc,0 2px 0 #c9c9c9,0 3px 0 #bbb,0 4px 0 #b9b9b9,0 5px 0 #aaa,0 6px 1px rgba(0,0,0,.1),0 0 5px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.3),0 3px 5px rgba(0,0,0,.2),0 5px 10px rgba(0,0,0,.25),0 10px 10px rgba(0,0,0,.2),0 20px 20px rgba(0,0,0,.15)");
        if (i == 3) I_FormatText("text-shadow", "-4px -2px 0 #fff");
        if (i == 4) I_FormatText("text-shadow", "2px 4px 3px rgba(0,0,0,0.3)");
        if (i == 5) I_FormatText("text-shadow", "2px 8px 6px rgba(0,0,0,0.2),0px -5px 35px rgba(255,255,255,0.3)");
        if (i == 6) I_FormatText("text-shadow", "0px 15px 5px rgba(0,0,0,0.1),10px 20px 5px rgba(0,0,0,0.05),-10px 20px 5px rgba(0,0,0,0.05)");
        if (i == 7) I_FormatText("text-shadow", "0px 3px 0px #b2a98f,0px 14px 10px rgba(0,0,0,0.15),0px 24px 2px rgba(0,0,0,0.1),0px 34px 30px rgba(0,0,0,0.1)");
        if (i == 8) I_FormatText("text-shadow", "6px 6px 0px rgba(0,0,0,0.2)");
        if (i == 9) I_FormatText("text-shadow", "0px 4px 3px rgba(0,0,0,0.4),0px 8px 13px rgba(0,0,0,0.1),0px 18px 23px rgba(0,0,0,0.1)");
        if (i == 10) I_FormatText("text-shadow", "1px 1px 1px rgba(255,255,255,0.6)");
        if (i == 11) I_FormatText("text-shadow", "rgba(0,0,0,0.5) -1px 0, rgba(0,0,0,0.3) 0 -1px, rgba(255,255,255,0.5) 0 1px, rgba(0,0,0,0.3) -1px -2px")
    } else {
        var arrStyle = [];
        if (i == -1) I_FormatText("text-shadow", "");
        if (i == 0) arrStyle.push(["textShadow", "0px 2px 3px #666"]);
        if (i == 1) arrStyle.push(["textShadow", "4px 4px 0px rgba(255,255,255,.8), 10px 10px 0px rgba(187,187,187,0.5)"]);
        if (i == 2) arrStyle.push(["textShadow", "0 1px 0 #ccc,0 2px 0 #c9c9c9,0 3px 0 #bbb,0 4px 0 #b9b9b9,0 5px 0 #aaa,0 6px 1px rgba(0,0,0,.1),0 0 5px rgba(0,0,0,.1),0 1px 3px rgba(0,0,0,.3),0 3px 5px rgba(0,0,0,.2),0 5px 10px rgba(0,0,0,.25),0 10px 10px rgba(0,0,0,.2),0 20px 20px rgba(0,0,0,.15)"]);
        if (i == 3) arrStyle.push(["textShadow", "-4px -2px 0 #fff"]);
        if (i == 4) arrStyle.push(["textShadow", "2px 4px 3px rgba(0,0,0,0.3)"]);
        if (i == 5) arrStyle.push(["textShadow", "2px 8px 6px rgba(0,0,0,0.2),0px -5px 35px rgba(255,255,255,0.3)"]);
        if (i == 6) arrStyle.push(["textShadow", "0px 15px 5px rgba(0,0,0,0.1),10px 20px 5px rgba(0,0,0,0.05),-10px 20px 5px rgba(0,0,0,0.05)"]);
        if (i == 7) arrStyle.push(["textShadow", "0px 3px 0px #b2a98f,0px 14px 10px rgba(0,0,0,0.15),0px 24px 2px rgba(0,0,0,0.1),0px 34px 30px rgba(0,0,0,0.1)"]);
        if (i == 8) arrStyle.push(["textShadow", "6px 6px 0px rgba(0,0,0,0.2)"]);
        if (i == 9) arrStyle.push(["textShadow", "0px 4px 3px rgba(0,0,0,0.4),0px 8px 13px rgba(0,0,0,0.1),0px 18px 23px rgba(0,0,0,0.1)"]);
        if (i == 10) arrStyle.push(["textShadow", "1px 1px 1px rgba(255,255,255,0.6)"]);
        if (i == 11) arrStyle.push(["textShadow", "rgba(0,0,0,0.5) -1px 0, rgba(0,0,0,0.3) 0 -1px, rgba(255,255,255,0.5) 0 1px, rgba(0,0,0,0.3) -1px -2px"]);
        obj.applySpanStyle(arrStyle)
    }
}
...
function I_InsertCol(bLeft) {
    ...
    for (var i = 0; i < oTable.rows.length; i++) {
        ...
        if (bLeft) {
            ...
            oNewCell.className = oTD.className;
...
function I_InsertRow(bAbove) {
    ...
    for (var i = 0; i < oTR.cells.length; i++) {
        ...
        oNewTD.className = oTD.className;
        oNewTD.innerHTML = "&nbsp;"
    }
    if (navigator.appName.indexOf('Microsoft') != -1) {
        obj.runtimeBorder(false)
...
function applyFormat(sName) {
    ...
    for (var i = 0; i < oTable.rows.length; i++) {
        ...
        for (var j = 0; j < oTR_tmp.cells.length; j++) {
            if (j == 0) oTR_tmp.cells[j].className = sFirstCell;
            if (i == 0) oTR_tmp.cells[j].className = sHeaderRowClass;
        ...
        if (navigator.appName.indexOf('Microsoft') != -1) {
            ...
            if (oSel.parentElement) {
                if (oSel.text == "") {
                    ...
                    if (oElement) if (oElement.tagName != "BODY") I_SetCss(oElement, cssRule, cssVal)
                } else {
                    obj.applySpanStyle([[cssRule, cssVal]])
                }
            } else {
                oElement = oSel.item(0);
                if (oElement) I_SetCss(oElement, cssRule, cssVal)
            }
        } else {
            oSel = oEditor.getSelection();
            oElement = parent.getSelectedElement(oSel);
        ...
        if (range.toString() == "") {
            if (range.startContainer.nodeType == Node.ELEMENT_NODE) {
                if (range.startContainer.nodeName == "IMG") {
                    ...
                    emptySel = false
                } else if (range.startContainer.childNodes[range.startOffset] != null && range.startContainer.childNodes[range.startOffset].nodeType != Node.TEXT_NODE) {
