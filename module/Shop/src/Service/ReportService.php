...
class ReportService implements ServiceLocatorAwareInterface
{
    ...
    public function createProductList(array $post)
    {
        ...
        /* @var $product \Shop\Model\ProductModel */
        foreach ($products as $key => $product) {
            ...
            if ($previousCategory !== $currentCategory) {
                ...
                /* @var $category \Shop\Model\ProductCategoryModel */
    ...
    public function getReportsOptions()
    {
        ...
        $service = $sl->get(ReportsOptions::class);
    ...
    public function getProductService()
    {
        ...
        $service = $sl->get(ProductService::class);
    ...
    public function getProductCategoryService()
    {
        $sl = $this->getServiceLocator()
        ->get(ServiceManager::class);
        $service = $sl->get(ProductCategoryService::class);
    ...
    public function getOrderService()
    {
        $sl = $this->getServiceLocator()
            ->get(ServiceManager::class);
        $service = $sl->get(OrderService::class);
