...
class PaypalService extends AbstractService
{
    ...
    /**
     * @var \Shop\Service\OrderStatusService
     */
    ...
    public function createPayment(OrderModel $order)
    {
        ...
        /* @var $orderItem \Shop\Model\OrderLineModel */
    ...
    /**
     * @return array|object|OrderStatusService
     */
    public function getOrderStatusService()
    {
        if (!$this->orderStatusService) {
            $service = $this->getServiceLocator()->get(OrderStatusService::class);
    ...
    public function getOptions()
    {
        if (!$this->options instanceof PaypalOptions) {
            $options = $this->getServiceLocator()->get(PaypalOptions::class);
